...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT_myr(
      ...
      KC_LSFT , KC_Z ,  KC_X   ,  KC_C  ,   KC_V ,   KC_B , ADJUST , MOUSE ,     UPDIR  , HOMEDIR, KC_N ,  KC_M ,KC_COMM, KC_DOT ,KC_SLSH, KC_RSFT,
    ...
    [_COLEMAK_DH] = LAYOUT_myr(
      ...
      KC_LSFT , KC_Z ,  KC_X   ,  KC_C  ,   KC_D ,   KC_V , ADJUST , MOUSE ,     UPDIR  , HOMEDIR, KC_K,   KC_H ,KC_COMM, KC_DOT ,KC_SLSH, KC_RSFT,
                                 ADJUST , KC_LGUI, ALT_SPC, NAV , SYM   ,     SYM    , KC_SPC , ALT_ENT, KC_RGUI, KC_DEL,
